...
async function inspectLiveTemplates() {
  ...
  console.log('Fetching GET /api/templates from Whats AI live server...');
  const res = await axios.get(`${baseUrl}/api/templates`, {
    headers: {
  ...
  console.log('Live Templates Response Status:', res.status);
  console.log('Live Templates Data:', JSON.stringify(res.data, null, 2));
}

inspectLiveTemplates();
