...
async function testAiAssistantRaj() {
  ...
  console.log("=== Sending ai_assistant to 918726525782 ===");
  ...
  // Wait 4 seconds for Meta webhook to update status
  ...
  console.log("Webhook Final Status for ai_assistant on 918726525782:", target?.status, "errorReason:", target?.errorReason);
}

testAiAssistantRaj().catch(console.error);
